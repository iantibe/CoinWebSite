...
/**
 * Servlet implementation class deletelocationdataservlet
 */
@WebServlet("/deletelocationdataservlet")
public class deletelocationdataservlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public deletelocationdataservlet() {
        super();
